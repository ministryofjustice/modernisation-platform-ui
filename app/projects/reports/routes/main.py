...
from app.projects.reports.services.service import (
    get_all_json_data,
    get_readme_incident_info,
    get_collaborators_data,
)
...
def platform_access_summary():
    ...
    def env_sort_key(item):
        ...
        return (
            order.get(env_name, 999),
            env_name,
        )  # Unknown environments go last, then alphabetically
...
def platform_environments_summary():
    ...
    env_type_counts = {"production": 0, "preproduction": 0, "test": 0, "development": 0}
